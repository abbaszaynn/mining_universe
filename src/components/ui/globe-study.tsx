...
// Rendered inside a sandboxed iframe rather than injected into the page, so
// its self-contained canvas/JS never touches this app's DOM, React tree, or
// global scope.
