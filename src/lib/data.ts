...
export const news: NewsArticle[] = [
  ...
  },
  {
    ...
    content: 'Ruby and building marble can come out of the same rock. That is not a quirk of geography, it is how the mineral forms. Gem-quality corundum grows inside metamorphosed dolomitic marble, which means a single formation can hold something a jeweller wants and something a quarry wants, sitting metres apart, and it is exactly the combination our Bagicha concession carries.\n\nMost concessions get valued on one commodity. Bagicha genuinely does not work that way: across roughly 20 sq/km it carries ruby gemstones, snow white marble, quartz and lithium-bearing indications together, which supports two quite different buyers from a single licence rather than one. A gem dealer evaluates it entirely differently from a stone buyer looking at marble and quartz as construction material, and both are legitimate reasons to be talking to us about the same site.\n\nThe geological basis for the ruby specifically is published, independent survey literature rather than a claim we are making about our own ground, and we have laid it out in full on the [Bagicha concession page](/concessions/bagicha-skardu-gemstones-and-minerals) rather than summarising it twice.\n\nWhat is more useful here is the buyer side. A gem dealer sourcing rough ruby direct from a licence holder, rather than through the trading layers most of this market runs on, is a meaningfully different proposition than the same stone changing hands three times before reaching them. We cover which markets that matters most for, and why, on our dedicated market pages.\n\nAssay work, boundary data and the full geological report stay with verified buyers through the investor desk rather than sitting on a public page. What is public is on the [Bagicha concession page](/concessions/bagicha-skardu-gemstones-and-minerals) and the [quartz and silica commodity page](/commodities/quartz-silica).',
  ...
  },
  {
    ...
    excerpt: 'Copper with gold is exactly the pairing behind Pakistan\'s two largest mineral deals of 2025. Neither deal touches our Shigar concession. It is the same commodity category at a considerably earlier stage, and that is worth being precise about.',
    content: 'Two deals defined Pakistani mining in 2025, and both were built on the same commodity pairing our Shigar concession carries. In September, Pakistan and US Strategic Metals signed a $500 million partnership covering exploration through refining. Separately, Saudi Arabia pursued a 15 percent stake in Reko Diq, Pakistan\'s flagship copper-gold project, backed by a reported $540 million commitment. Copper with gold, twice, at nine-figure scale.\n\nShigar is not part of either deal, and it would be misleading to let the timing imply otherwise. What it shares with both is the commodity category, at a considerably earlier stage than a $10 billion national flagship project or a federally brokered supply agreement. That is a different proposition, and it should be evaluated as one rather than borrowing credibility from headlines it is not attached to.\n\nWhat Shigar does have is a specific geological basis, published independently of anything on this site, tying the valley to the same structural belt that other regional surveys have already found encouraging results in. We have laid that evidence out in full, survey by survey, on the [Shigar concession page](/concessions/shigar-copper-deposit) itself rather than repeating it here.\n\nWhat this means practically for an investor: the two 2025 deals are a signal about where Pakistani mining capital and attention are currently pointed, not a claim about Shigar\'s own results. Full structural mapping and assay results go to verified investors through the investor desk once an enquiry is confirmed. Licence status, area, mineral indications and the geological survey evidence are all on the [Shigar Copper Deposit concession page](/concessions/shigar-copper-deposit).',
  ...
  },
  {
    ...
    excerpt: 'A polymetallic site is never mining just one thing, which is a different economic proposition to a single-mineral licence, and worth understanding on its own terms before it gets treated as a smaller version of one.',
    content: 'Most mineral licences get discussed as if they carry one commodity. A copper mine, a gold mine, an antimony deposit. Polymetallic sites like Hilal Abad do not work that way, and the difference is not just descriptive. It changes the underlying economics: a grade that would be marginal for a single metal can justify development once two or three others come out of the same ground alongside it.\n\nThat matters for how a prospective partner should actually evaluate a site like this. A polymetallic filing is not four separate small opportunities bundled together for a better pitch. It is one deposit whose commercial case depends on the combination, which means the right due diligence question is not how much of the headline mineral is there, but what the full basket looks like once processing and logistics costs are shared across all of it.\n\nKharmang district, where Hilal Abad sits, has drawn repeated attention in Pakistan\'s mineral resource surveys for exactly this kind of multi-metal geology, tied to the region\'s wider suture-zone structure. We have laid out the specific minerals, the survey context and the district\'s documented pattern on the [Hilal Abad concession page](/concessions/hilal-abad-polymetallic-complex) itself rather than restating it here.\n\nHilal Abad is currently held under an exploration licence rather than a mining lease, meaning the near-term work is confirmatory: mapping and sampling ahead of any future mining lease application, not extraction. That is a normal stage for a site of this size, and it is the stage where geological documentation matters most to a partner deciding whether to fund what comes next. That documentation is available to verified investors once an enquiry is confirmed through the investor desk, and licence status and mineral indications are summarised on the [Hilal Abad concession page](/concessions/hilal-abad-polymetallic-complex).',
