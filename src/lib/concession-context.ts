...
export const CONCESSION_CONTEXT: Record<string, ConcessionContext> = {
  ...
  "gojal-hunza-antimony-deposit": {
    narrative: [
      ...
      "This concession is held under an exploration licence, application #2024-3435, with antimony as the primary target and molybdenum indications also recorded by our own field work. That reflects where the work actually is: exploration, not extraction. Antimony demand has firmed globally on its role in flame retardants, battery chemistries and semiconductor manufacture, part of the commercial case for advancing this licence toward a mining lease. Field and assay data are shared with verified investors on request.",
    ],
