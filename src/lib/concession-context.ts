...
export const CONCESSION_CONTEXT: Record<string, ConcessionContext> = {
  ...
  "gultari-polymetallic-ores": {
    narrative: [
      ...
      "The licensed area carries molybdenum, antimony, lead, and gemstone indications across roughly 20 sq/km. Durr & Zircon holds the concession under an active operational lease. Topography mapping for the site is listed under Documents, and the geological report itself is part of the data room shared with verified counterparties.",
    ],
  ...
  "hilal-abad-polymetallic-complex": {
    narrative: [
      "Hilal Abad falls within the Kharmang district mineral belt in Baltistan, an area whose polymetallic potential has drawn repeated attention in Pakistan's mineral resource surveys: copper, iron, silver and associated base metals tied to the region's Kohistan-Ladakh suture geology. It sits close enough to the district's documented antimony and molybdenum showings that the two are frequently discussed in the same regional surveys, though they remain separate licensed areas.",
      "The concession is described in its filings as a polymetallic ore structure carrying copper, iron, silver and gold across roughly 9.97 sq/km, held under an exploration licence rather than a mining lease at this stage. That means the current priority is confirmatory work ahead of any future mining lease application. Geological documentation is available to verified investors once an enquiry is confirmed.",
    ],
  ...
  "shigar-copper-deposit": {
    narrative: [
      ...
      "The concession carries copper ore as its primary indication, with gold alongside copper noted as a strong secondary signal, across roughly 8.87 sq/km. The site is operational under Zircon Mines' licence. Of every concession currently on this registry, this one has the strongest regional geological correlation behind it. Full structural and assay data are shared with verified investors directly.",
    ],
  ...
  "gojal-hunza-antimony-deposit": {
    narrative: [
      ...
      "This concession is held under an exploration licence, application #2024-3435, with antimony as the primary target. That reflects where the work actually is: exploration, not extraction. Antimony demand has firmed globally on its role in flame retardants, battery chemistries and semiconductor manufacture, part of the commercial case for advancing this licence toward a mining lease. Field and assay data are shared with verified investors on request.",
    ],
