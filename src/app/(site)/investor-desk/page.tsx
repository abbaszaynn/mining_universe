...
export const metadata = createPageMetadata({
  title: "Investor Desk",
  description:
    "Partner with Durr & Zircon Consortium. Submit an inquiry to connect with licensed mining operators in Gilgit Baltistan — field visits, due diligence, and global investment opportunities.",
  path: "/investor-desk",
});
